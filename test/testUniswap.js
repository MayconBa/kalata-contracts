...
const {deploy, deployUniswapV2Router02, deployUniswapV2Factory, randomAddress, deployToken, loadPair} = require("../utils/contract")
...
describe("Uniswap", () => {
    ...
    describe("createPair", async () => {
        it("pair address", async () => {
            ...
            deadline = (await hre.web3.eth.getBlock("latest")).timestamp + 160;
